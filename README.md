[![CI](https://github.com/gozelle/openapi/workflows/go/badge.svg)](https://github.com/gozelle/openapi/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/gozelle/openapi)](https://goreportcard.com/report/github.com/gozelle/openapi)
[![GoDoc](https://godoc.org/github.com/gozelle/openapi?status.svg)](https://godoc.org/github.com/gozelle/openapi)
...
* [OpenAPI `v3.1`](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md) Soon! [Tracking issue here.](https://github.com/gozelle/openapi/issues/230)

Licensed under the [MIT License](./LICENSE).

## Contributors, users and sponsors
The project has received pull requests [from many people](https://github.com/gozelle/openapi/graphs/contributors). Thanks to everyone!
...
Here's some projects that depend on _kin-openapi_:
  ...
  * (Feel free to add your project by [creating an issue](https://github.com/gozelle/openapi/issues/new) or a pull request)
...
# Structure
  * _openapi2_ ([godoc](https://godoc.org/github.com/gozelle/openapi/openapi2))
    * Support for OpenAPI 2 files, including serialization, deserialization, and validation.
  * _openapi2conv_ ([godoc](https://godoc.org/github.com/gozelle/openapi/openapi2conv))
    * Converts OpenAPI 2 files into OpenAPI 3 files.
  * _openapi3_ ([godoc](https://godoc.org/github.com/gozelle/openapi/openapi3))
    * Support for OpenAPI 3 files, including serialization, deserialization, and validation.
  * _openapi3filter_ ([godoc](https://godoc.org/github.com/gozelle/openapi/openapi3filter))
    * Validates HTTP requests and responses
    * Provides a [gorilla/mux](https://github.com/gorilla/mux) router for OpenAPI operations
  * _openapi3gen_ ([godoc](https://godoc.org/github.com/gozelle/openapi/openapi3gen))
    * Generates `*openapi3.Schema` values for Go types.

# Some recipes
## Validating an OpenAPI document
```shell
go run github.com/gozelle/openapi/cmd/validate@latest [--defaults] [--examples] [--ext] [--patterns] -- <local YAML or JSON file>
```
...
### v0.51.0
* Type `openapi3filter.Route` moved to `routers` (and `Route.Handler` was dropped. See https://github.com/gozelle/openapi/issues/329)
